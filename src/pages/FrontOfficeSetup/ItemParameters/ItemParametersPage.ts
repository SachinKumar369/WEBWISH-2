...
export class ItemParametersPage extends BaseCrudPage {
  ...
  private readonly itemParametersLink = this.page.getByRole('link', { name: 'Item Parameters' });
  ...
  protected async openPage(): Promise<void> {
    ...
    if (this.isFirstTime) {
      ...
      await this.elementActions.click(this.itemParametersLink, 'Item Parameters');
