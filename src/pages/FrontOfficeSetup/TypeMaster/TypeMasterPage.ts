...
export class TypeMasterPage extends BaseCrudPage {
  ...
  private readonly typeMasterLink = this.page.getByRole('link', { name: 'Type Master' });
  ...
  protected async openPage(): Promise<void> {
    ...
    if (this.isFirstTime) {
      ...
      await this.elementActions.click(this.typeMasterLink, 'Type Master');
