...
export class UserDefinedCodesPage extends BaseCrudPage {
  ...
  protected async openPage(): Promise<void> {
    ...
    if (this.isFirstTime) {
      ...
      await this.elementActions.click(this.userDefinedCodesLink, 'User Defined Codes');
    ...
    await this.elementActions.click(menu.nth(1), this.screenName);
